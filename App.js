  ...
  useEffect(() => {
    (async () => {
      ...
      if (!granted) {
        Alert.alert(
          "",
          "Run Every Street collects location data to enable drawing of the trail you are running, and could be collected even when the app is closed or not in use.",
          [
